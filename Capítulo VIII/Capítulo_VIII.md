...
- **Medida 1 (M2-01):** Tasa de interacción activa con el componente de confirmación (DBM-04). Se recolectará mediante consultas en la base de datos (Supabase) al final de la sesión de pruebas con los 3 empleados.
...
- **Medida 1 (M4-01):** Tasa de conflictos de ocupación (DBM-06). Se observará directamente durante las sesiones de prueba con 3 gerentes, verificando si ocurren doble reservas en la base de datos.
