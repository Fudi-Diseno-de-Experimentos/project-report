...
">
  ...
  <img src="Anexos/cover//upc.svg" alt="UPC-LOGO" width="150" style="margin-bottom: 30px;"/>

  <h2 style="margin: 5px 0;">Universidad Peruana de Ciencias Aplicadas</h2>
  <h3 style="margin: 5px 0;">Facultad de Ingeniería</h3>

<p style="margin: 5px 0;"><strong>Curso:</strong> 1ASI0732 | Diseño de Experimentos de Ingeniería de Software</p>
<p style="margin: 5px 0;">NRC: <strong>17821</strong></p>
<p style="margin: 5px 0;"><strong>Nombre del profesor:</strong>  Lennin Percy Cenas Vasquez</p>
...
| 2.0         | 05 julio 2026 | u20231045 - Aguirre Castillo Sergio Cesar<br />u202310931 - Bellido Salas Raúl<br />u202319889 - Contreras Peralta, Fabrizio Alessandro<br />U20231B866 - Curipaco Huayllani, Neil Aldrin Wilhelm<br />u201910803 - Heredia Hoyos Danitza Ivonne | Consolidación del informe final del Trabajo Final. Incorporación de las secciones de To-Be User Stories, To-Be Product Backlog y To-Be Sprint Backlog para el Sprint 3. Redacción de las evidencias de implementación del MVP en la Landing Page, App Mobile y Web Service. Documentación y diseño metodológico de las entrevistas de validación, registro de 5 entrevistas y análisis cuantitativo de resultados por experimento. Implementación del flujo de trabajo de aprendizaje continuo (Continuous Learning), incluyendo diagramas Mermaid, Learning Cards y la Matriz de Plan de Acción para la consolidación final en producción. Redacción de las conclusiones del Trabajo Final en bibliografia y llenado de la sección de Video App Validation. |
...
- **raulbellido (Raúl Bellido):** Participó en la supervisión y validación del *Product Backlog* y las historias de usuario en el Capítulo 3, asegurando la coherencia del modelo de negocio SaaS.
...
- **seratt15a (Sergio Aguirre):** Documentó el diseño y ejecución de las prácticas de DevOps, especificando la configuración de los componentes de Integración y Entrega Continua (CI/CD) para los productos de la startup.
- **Neilcuri7 (Neil Curipaco):** Responsable de la consolidación técnica del informe, integrando las evidencias de las pruebas unitarias e integrales de la aplicación móvil y los resultados de los tests de sistema realizados con Patrol.
- **UDnTzh (Danitza Heredia):** Gestionó la actualización de las secciones de diseño de la aplicación móvil y colaboró en la redacción de las evidencias de implementación de las funcionalidades de anuncios y eventos.
- **fabriziocpa (Fabrizio Contreras):** Se centró en la validación y reporte de los escenarios de Core System Tests, aportando los datos de las interacciones extremo a extremo para asegurar la integridad de la solución completa.
- **raulbellido (Raúl Bellido):** Encargado de documentar la suite de pruebas del backend, detallando la lógica de los Unit e Integration Tests en Java y validando que las capturas de resultados reflejen el aislamiento de datos requerido.
...
- **seratt15a (Sergio Aguirre):** Se encargó de la documentación y actualización de las nuevas suites de pruebas Unitarias, de Integración y de Sistema (Core System Tests) en el informe.
- **Neilcuri7 (Neil Curipaco):** Lideró la corrección técnica de DevOps y realizó el diseño, estructuración e implementación de Experiment-Driven Development.
- **UDnTzh (Danitza Heredia):** Coordinó y ejecutó el registro y la edición del material audiovisual correspondiente a las entrevistas de validación.
- **fabriziocpa (Fabrizio Contreras):** Realizó las correcciones en el diseño de las interfaces de usuario de la aplicación móvil basadas en las heurísticas resultantes de las entrevistas de validación.
- **raulbellido (Raúl Bellido):** Lideró la evaluación de heurísticas aplicada al equipo auditado, redactó la Sección 6.4 (Auditoría de Experiencias de Usuario) y participó activamente en la grabación de las entrevistas de validación.

**TF:**

Durante el periodo de desarrollo del Trabajo Final (TF), el equipo coordinó la integración de los resultados experimentales finales, la documentación técnica y las evidencias de validación de Centralis en producción mediante ramas en el repositorio GitHub.

<p align="center">
  <img src="https://i.imgur.com/Se8bEIi.png" alt="Descripción">
</p>



A continuación, se detalla la contribución de cada integrante:

- **seratt15a (Sergio Aguirre):** Grabó y documentó las entrevistas del segmento 1 y 2 en la sección "To-Be Validation Interviews" y colaboró activamente en el análisis de resultados.
- **Neilcuri7 (Neil Curipaco):** Documentó la sección de ciclo de vida guiado por experimentos (EDD) en la sección Pipeline-supported, Experiment-Driven To-Be Software Platform Lifecycle y lideró la integración técnica del reporte.
- **UDnTzh (Danitza Heredia):** Grabó y documentó las entrevistas del segmento 3 en la sección "To-Be Validation Interviews", y lideró la edición y publicación del video final de validación de la aplicación en OneDrive.
- **fabriziocpa (Fabrizio Contreras):** Implementó las nuevas funcionalidades para la aplicación móvil nativa  y el backend REST API en Spring Boot.
- **raulbellido (Raúl Bellido):** Grabó y documentó las entrevistas de validación del segmento 4 y 5 en la sección "To-Be Validation Interviews", y participó en el diseño de los cuestionarios cualitativos.
...
- [Capítulo VIII: Experiment-Driven Development](#captulo-viii-experiment-driven-development)
  ...
  - [8.4. Experiment Aftermath & Analysis](#84-experiment-aftermath--analysis)
    - [8.4.1. Analysis and Interpretation of Results](#84-analysis-and-interpretation-of-results)
    - [8.4.2. Re-scored and Re-prioritized Question Backlog](#84-re-scored-and-re-prioritized-question-backlog)
